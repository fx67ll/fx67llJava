...
## 0.2.8.20211119
* 更新笔记：Maven安装与环境配置教程（未完成，待补充拓展）  
* 更新笔记：解决 IDEA 2021.2.3 新建maven项目只有两个archetype项目模板的问题（已完成发布）  

## 0.2.7.20211103
* 更新笔记：浅谈Java中的浅拷贝和深拷贝（未完成，待补充拓展）  
...
## 0.2.2.20211019
* 更新笔记：浅谈Java和JavaScript中变量和数据类型的区别（已完成发布）  

## 0.2.1.20211018
* 更新笔记：Java开发环境配置（已完成发布）  
* 更新笔记：IDEA 2021.2.3 安装与破解教程（已完成发布）  
